...
?>
<style>
	.division{width: 48%; float: left; margin: 0 1%}
	.tblone{width: ; margin: 0 auto; border: 2px solid #ddd;}
	...
	.ordernow a{width: 200px; margin: 20px auto 0; text-align: center; color: #fff; background: #ff0000; padding: 5px; border-radius: 3px; display: block; font-size: 30px; }
