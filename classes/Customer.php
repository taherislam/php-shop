...
<?php  
	...
	public function customerRegistration($data){
	    ...
	    if ($mailchk != false) {
			...
			if ($inseted_row) {
				$msg = "<span class='success'>Customer Registration From Success.<span>";
				return $msg;
			}else{
				$msg = "<span class='error'>Customer Registration From not Success.<span>";
				return $msg;
			}
	    }
	}
	...
	public function customerUpdate($data, $cmrId){
		...
		if ($name == "" || $address == "" || $city == "" || $country == "" || $zip == "" || $phone == "" || $email == "" ){
			...
			if ($updated_row) {
				...
				$msg = "<span class='success'>Customer Data Not Updated !<span>";
				return $msg;	
			}
	    }
	}
